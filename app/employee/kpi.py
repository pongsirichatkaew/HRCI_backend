...
def QryEmployee_kpi_one(cursor):
    try:
        ...
        sqlGM = "SELECT old_grade_GM,status_GM,positionChange_GM,specialMoney_GM,newKpiDescriptions_GM FROM employee_kpi WHERE employeeid=%s AND year=%s AND term=%s"
